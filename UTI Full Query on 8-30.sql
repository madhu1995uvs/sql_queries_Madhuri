...
,REASON_FOR_VISIT,ESI,PT_DX1,PT_DX2,PT_DX3,patient_mrn_bb, checkin_date_time_bb
,temp1.TEMP_1
...
--left outer join temp_first on tat.PATIENT_FIN = temp_first.temp_pt_fin
 ...
 left outer join 
  ...
  From  (Select *,RN=Row_Number() over (Partition By PT_FIN Order by [result_Dt_tm],TEMPERATURE_RESULT)
  From [EMTCQIData].[dbo].[ED_Vitals_Import_Master]
  where TEMPERATURE_RESULT is not null ) temp1
  Group by PT_FIN) 
  temp1 on tat.PATIENT_FIN = temp1.temp_pt_fin
